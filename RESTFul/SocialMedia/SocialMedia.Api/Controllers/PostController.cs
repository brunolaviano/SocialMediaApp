...
namespace SocialMedia.Api.Controllers
{
    ...
    public class PostController : ControllerBase
    {
        ...
        /*Devolver un Codigo especifico y un tipo de respuesta especifica para un IActionResult*/
        ...
        {
            /*Forma "antigua" para Validar los Modelos
             * Ahora se Valida automaticamente a traves del [ApiControler]
             * O a traves de los Filters (Validaciones personalizadas[ValidationFilter])
